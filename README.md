...
8. **Inputs and Outputs:** So originally I had SDATA_IN and BIT_CLK as set to outputs.  When I changed them however, I forgot to delete the instance of the peripheral so that the new changes can be implemented.  I had no idea that this would make a difference, but apparently it does! Now I know.  When I tried compiling it, however, I got another error.  I asked Dr. Coulston what this could mean, and after looking at my .mpd file, he said that I had two unneeded ports declared throughout my code.  We deleted the extra ports and 
